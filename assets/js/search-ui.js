...
function attach(form){
  ...
  const smartAction=query=>`<a class="smart-search-action" role="option" href="${searchUrl(query)}&smart=1"><span class="smart-search-icon">✦</span><span><b>SHOPLAB+ · Melhor para mim</b><small>Usa sua busca e seus interesses para encontrar custo-benefício</small></span><span class="smart-search-arrow"></span></a>`;
