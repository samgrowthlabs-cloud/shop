...
async function apiEnvelope(path,signal){const response=await fetch(`${C.API_BASE_URL}${path}`,{signal});if(!response.ok)throw new Error('Busca indisponível');const json=await response.json();return{items:json.data||[],meta:json.meta||{}}}
