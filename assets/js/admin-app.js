...
const moduleImports={main:()=>import('./admin.js?v=20260829-audit-all-1'),v2:()=>import('./admin-v2.js?v=20260829-r2-ffmpeg-21'),ads:()=>import('./shoplab-ads.js?v=20260831-campaign-cards-6'),converter:()=>import('./media-converter.js?v=20260829-r2-ffmpeg-21'),recorder:()=>import('./audio-recorder.js?v=20260831-browser-ai-4'),mixer:()=>import('./audio-mixer.js?v=20260829-r2-ffmpeg-21')};
