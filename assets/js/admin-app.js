...
const moduleImports={taxonomy:()=>import('./admin-taxonomy.js?v=20260908-discovery-1'),main:()=>import('./admin.js?v=20260903-product-count-1'),v2:()=>import('./admin-v2.js?v=20260908-discovery-1'),news:()=>import('./admin-news.js?v=20260911-news-engagement-2'),ads:()=>import('./shoplab-ads.js?v=20260831-ads-native-frequency-15'),converter:()=>import('./media-converter.js?v=20260829-r2-ffmpeg-21'),recorder:()=>import('./audio-recorder.js?v=20260831-browser-ai-4'),mixer:()=>import('./audio-mixer.js?v=20260829-r2-ffmpeg-21'),call:()=>import('./admin-team-call.js?v=20260905-team-call-v5')};
