...
ensureHead();
if('serviceWorker'in navigator&&location.protocol!=='file:')window.addEventListener('load',()=>navigator.serviceWorker.register('/sw.js?v=20260802-mobile-no-gap-cache-9').then(registration=>registration.update()).catch(()=>{}));
