...
if('serviceWorker'in navigator&&location.protocol!=='file:')window.addEventListener('load',()=>navigator.serviceWorker.register('/sw.js?v=20260820-product-card-image-1').then(registration=>registration.update()).catch(()=>{}));
