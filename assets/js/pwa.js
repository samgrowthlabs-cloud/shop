...
if('serviceWorker'in navigator&&location.protocol!=='file:')window.addEventListener('load',()=>navigator.serviceWorker.register('/sw.js?v=20260827-auth-syntax-cache-2').then(registration=>registration.update()).catch(()=>{}));
